...
export const spec: DiagramSpec = {
  ...
  nodes: [
    ...
    },
    {
      id: "approvers",
      title: "Approvers (x2)",
      subtitle: "Each reveals a distinct secret via ApproveRun",
      subtitle2: "FundCommitment reverts QUORUM_NOT_MET until both land",
      tone: "accent",
      cluster: "payroll",
      penwidth: "2",
    },
    {
      ...
      subtitle2: "owner_secret proves run ownership · quorum required to fund",
      tone: "backend",
      cluster: "payroll",
      penwidth: "2.5",
    },
    {
      ...
      subtitle2: "owner + approver commitments (secret-proven) · no addresses",
      tone: "backend",
      cluster: "payroll",
    },
    {
  ...
  edges: [
    ...
    { from: "approvers", to: "openfund", label: "ApproveRun", kind: "success" },
