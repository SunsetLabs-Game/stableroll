...
export const spec: DiagramSpec = {
  ...
  nodes: [
    ...
    },
    {
      id: "approve",
      title: "ApproveRun (x2)",
      subtitle: "Each approver reveals a distinct secret",
      subtitle2: "Matches approver_a/b_commitment · sets approved_a/b",
      tone: "accent",
      penwidth: "2",
    },
    {
      id: "quorum",
      title: "Quorum met?",
      subtitle: "approved_a AND approved_b",
      shape: "diamond",
      tone: "decision",
      penwidth: "2",
    },
    {
      id: "quorum_not_met",
      title: "QUORUM_NOT_MET",
      subtitle: "FundCommitment reverts until both approvers have called ApproveRun",
      tone: "danger",
      penwidth: "2",
    },
    {
  ...
  edges: [
    ...
    { from: "open", to: "approve" },
    { from: "approve", to: "approve", label: "second approver" },
    { from: "approve", to: "quorum" },
    { from: "quorum", to: "fund", label: "both approved", kind: "success", penwidth: "2" },
    {
      from: "quorum",
      to: "quorum_not_met",
      label: "funding attempted early",
      kind: "danger",
      style: "dashed",
    },
